...
import { TestComponent } from './formscontrols/test/test.component';
import { EssaieComponent } from './formcontrols/essaie/essaie.component';
import { AngeComponent } from './ange/ange.component';
import { GrouperComponent } from './envoie/grouper/grouper.component';
import { IndividuelComponent } from './envoie/individuel/individuel/individuel.component';
import { FilialesComponent } from './filiales/liste/filiales.component';
import { CreerfilialeComponent } from './filiales/creer/creerfiliale/creerfiliale.component';
import { HistoriqueComponent } from './historique/historique.component';
import { CreerComponent } from './compte/creer/creer.component';
import { GestionComponent } from './compte/gestion/gestion.component';
import { ModelsmsComponent } from './parametres/modelsms/modelsms.component';
import { LatenceComponent } from './parametres/latence/latence.component';
import { TachecronComponent } from './parametres/tachecron/tachecron.component';
...
const routes: Routes = [
	{
      ...
      {
				path: 'form-controls/essaie',
				component: EssaieComponent
      },
      {
				path: 'envoie/grouper',
      ...
      {
				path: 'envoie/individuel',
				component: IndividuelComponent
      },
      {
				path: 'filiales/liste/filiales',
				component: FilialesComponent
      },
      {
				path: 'filiales/creer/creerfiliale',
				component: CreerfilialeComponent
      },
      {
				path: 'historique',
      ...
      {
				path: 'parametres/modelsms',
				component: ModelsmsComponent
      },
      {
				path: 'parametres/latence',
				component: LatenceComponent
      },
      {
				path: 'parametres/tachecron',
				component: TachecronComponent
      },
      {
				path: 'compte/gestion',
