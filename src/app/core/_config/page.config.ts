  ...
  public defaults: any = {
    ...
    material: {
      ...
      'form-controls': {
        ...
        essaie: {
          page: {title: 'Essaie', desc: ''}
        },
        historique: {
          page: {title: 'historique SMS', desc: ''}
        },
        envoie: {
          grouper: {
            page: {title: 'grouper', desc: ''}
          },
          individuel: {
            page: {title: 'individuel', desc: ''}
          }
        },
        filiales: {
          creer: {
            page: {title: 'creer', desc: ''}
          },
          filiales: {
            page: {title: 'filiales', desc: ''}
          }
        },
        parametres: {
          modelsms: {
            page: {title: 'model sms', desc: ''}
          },
          latence: {
            page: {title: 'latence', desc: ''}
          },
          tachecron: {
            page: {title: 'tache cron', desc: ''}
          }
        },
        checkbox: {
