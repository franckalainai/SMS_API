...
/**
            {
              ...
              submenu: [
                ...
                {
                  title: 'Essaie',
                  page: '/material/form-controls/essaie'
 ...
 */
            ...
            },
            {
              ...
              submenu: [
                {
                  title: 'Grouper',
                  page: '/material/envoie/grouper'
                },
                {
                  title: 'Individuel',
                  page: '/material/envoie/individuel'
                }
              ]
            },

            {
              ...
              submenu: [
                {
                  title: 'Creer',
                  page: '/material/filiales/creer/creerfiliale'
                },
                {
                  title: 'Filiales',
                  page: '/material/filiales/liste/filiales'
                }
              ]
            },

            {
              ...
              submenu: [
                {
                  title: 'Model SMS',
                  page: '/material/parametres/modelsms'
                },
                {
                  title: 'Modifier Temps Latence',
                  page: '/material/parametres/latence'
                },
                {
                  title: 'Tache CRON',
                  page: '/material/parametres/tachecron'
                }
              ]
            }
